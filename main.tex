...
\section*{Artefatos}
Todos os artefatos utilizados neste trabalho (códigos-fonte, dados e materiais complementares) estão disponíveis no link a seguir: \url{https://github.com/alobogiron/relatorio-pibic-2025}.
