...
\input{sections/04-trab-futuros.tex}
...
\begin{center}
    Apêndice A - Diagrama utilizado para reestruturação do código do dispositivo
\end{center}
\vspace{-2em}
...
\begin{figure}[ht]
    \center
    \includegraphics[scale=0.5]{images/diagrama_1.png}
...
\begin{figure}[ht]
    \center
    \includegraphics[scale=0.5]{images/diagrama_2.png}
    \label{fig:dashboard_1}
\end{figure}
...
\begin{figure}[ht]
    \center
    \includegraphics[scale=0.5]{images/diagrama_3.png}
    \label{fig:dashboard_1}
\end{figure}
...
\begin{figure}[ht]
    \center
    \includegraphics[scale=0.5]{images/diagrama_4.png}
    \label{fig:dashboard_1}
\end{figure}
...
\begin{figure}[ht]
    \center
    \includegraphics[scale=0.5]{images/diagrama_5.png}
    \label{fig:dashboard_1}
\end{figure}
\end{document}
