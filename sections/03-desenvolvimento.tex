...
A propagação da onda por trajetórias indesejadas é um problema de díficil resolução, tendo em vista que o indivíduo encontra-se em movimento e pode ser interceptado por ela por diversas ângulos. No entanto, existem diversos ajustes que podem ser realizados para melhorar a qualidade do evento capturado pelo módulo de sensoriamento e oferecer um evento mais caracterizado ao sistema. Deste modo, foram realizados testes para identificar customizações de caráter lógico e físico, que refinassem a coleta de informações, culminando na obtenção de padrões mais constantes e livres de irregularidades. 
